          ...
          <div className="deartmentList">
            {nameType == "department"
              ? departments?.map((department) => (
                  <div
                    key={
                      department._id ? department._id : department.departmentId
                    }
                    className="departmentCard"
                    onClick={() => {
                      Navigate(
                        `/dashboard/manage/${nameType}/${department._id}`
                      );
                    }}
                  >
              ...
              : employees?.map((employee) => (
                  <div
                    key={employee._id ? employee._id : Math.random()}
                    className="departmentCard"
                    onClick={() => {
                      Navigate(`/dashboard/manage/${nameType}/${employee._id}`);
                    }}
                  >
